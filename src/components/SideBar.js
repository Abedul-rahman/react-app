...
const SideBar = () => {
    ...
    return (
        ...
        <Link to="/Reserve"><div><img src={Reserve} alt=""/> <span>Reserve a Hall</span></div></Link>
        <Link to="/history"><div><img src={history}  alt=""/> <span>History</span></div></Link>
        {auth?.role==="ADMIN"&&<Link to="/reservations"><div><img src={reservation} alt=""/> <span>Reservations</span></div></Link>}
        {auth?.role==="ADMIN"&&<Link to="/RoomManagement"><div><img src={halls} alt="" /> <span>Management</span></div></Link>}
        {auth?.role==="ADMIN"&&<Link to="/Users"><div><img src={user} alt="" /> <span>Users</span></div></Link>}
